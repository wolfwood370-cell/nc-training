...
function DraggableExercise({ exercise, onEdit, onArchive }: DraggableExerciseProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={cn("flex items-center p-2.5 rounded-lg bg-card border border-border/50 hover:border-primary/30 hover:bg-primary/5 transition-all duration-150 group mx-0 px-0 gap-0",
