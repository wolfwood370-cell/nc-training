      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div
            ...
            className={cn(
              "absolute top-2 h-12 rounded-lg border-2 cursor-pointer transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
          ...
          <ScrollArea className="w-full">
            <div style={{ width: totalWidth + 80 }} className="min-w-full">
              ...
              <div
                role="button"
                tabIndex={0}
                aria-label="Clicca per aggiungere una nuova fase nella timeline"
                className="relative border-b border-border/50 cursor-crosshair focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                style={{ height: 64 }}
